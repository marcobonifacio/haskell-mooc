...
totalPrice (MkShoppingEntry _ p q) = p * fromIntegral q
...
buyOneMore (MkShoppingEntry name p q) = MkShoppingEntry name p (q+1)
...
setName name (PersonUndefined age n) = PersonUndefined age name

-- setAge does likewise for age
setAge :: Int -> Person -> Person
setAge age (PersonUndefined a name) = PersonUndefined age name
...
get :: UpDown -> Int
get (UpDownIncreasing value) = value
get (UpDownDecreasing value) = value

-- tick increases an increasing counter by one or decreases a
-- decreasing counter by one
tick :: UpDown -> UpDown
tick (UpDownIncreasing value) = UpDownIncreasing (value+1)
tick (UpDownDecreasing value) = UpDownDecreasing (value-1)

-- toggle changes an increasing counter into a decreasing counter and
-- vice versa
toggle :: UpDown -> UpDown
toggle (UpDownIncreasing value) = UpDownDecreasing value
toggle (UpDownDecreasing value) = UpDownIncreasing value

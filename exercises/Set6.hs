...
--import System.Win32.Console (COORD(yPos))
...
instance Eq Name where
  (==) :: Name -> Name -> Bool
  (==) (Name s) (Name t) = map Data.Char.toLower s == map Data.Char.toLower t
...
instance Num RationalNumber where
  ...
  abs (RationalNumber n d) = if n > 0 then RationalNumber n d else RationalNumber ((-1)*n) d
